...
// One-time arming after wizer resume; a successful no-op when the module was
// not transformed (everything then stays interpreted). Returns false only if
// arming a transformed module fails. Idempotent.
